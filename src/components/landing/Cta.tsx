    ...
    <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-green-600 to-green-800 text-white">
      <div className="max-w-7xl mx-auto text-center">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <Button asChild size="lg" className="px-6 py-3 bg-white text-green-700 font-medium rounded-lg hover:bg-gray-100 transition shadow-md hover:shadow-lg h-auto">
